      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <h2 className="typing-text">
            <TypeAnimation sequence={["Cyber Security Learner", 2000, "Digital Forensics Learner", 2000, "OSINT Learner", 2000, "IT Support", 2000]} wrapper="span" speed={50} repeat={Infinity} />
          </h2>
